...
from utils import call_in_path, cwd, run_cmd
from pcap_parse import merge_pcaps
...
urls = [
    ('https://data.caida.org/datasets/passive-2013/equinix-chicago/20131219-130000.UTC/','dirB', laurent),
    ('https://data.caida.org/datasets/passive-2013/equinix-sanjose/20131024-130000.UTC/','dirA', laurent),
    ('https://data.caida.org/datasets/passive-2014/equinix-chicago/20140619-130000.UTC/','dirB', laurent),
    ('https://data.caida.org/datasets/passive-2016/equinix-chicago/20160121-130000.UTC/','dirA', laurent),
    ('https://data.caida.org/datasets/passive-2016/equinix-chicago/20160121-130000.UTC/','dirB', laurent),
    ('https://data.caida.org/datasets/passive-2018/equinix-nyc/20180419-130000.UTC/','dirA', laurent)
]
